...
gameboard = {
  ...
  'tun': {'type': 'coastal', 'supply': 'neutral', 'borders': ['tyn', 'ion', 'naf', 'wes']},
  'naf': {'type': 'coastal', 'supply': 'none', 'borders': ['wes', 'tun', 'mid']},
  'mid': {'type': 'water', 'borders': ['nat', 'iri', 'eng', 'bre', 'gas', 'spa', 'por', 'wes', 'naf']},
  'iri': {'type': 'water', 'borders': ['nat', 'lvp', 'wal', 'eng', 'mid']},
  'lvp': {'type': 'coastal', 'supply': 'england', 'borders': ['cly', 'edi', 'yor', 'wal', 'iri', 'nat']},
  'cly': {'type': 'coastal', 'supply': 'none', 'borders': ['nat', 'nrg', 'edi', 'lvp']},
  'edi': {'type': 'coastal', 'supply': 'england', 'borders': ['nrg', 'nth', 'yor', 'lvp', 'cly']},
  'nth': {'type': 'water', 'borders': ['nrg', 'nwy', 'ska', 'den', 'hel', 'hol', 'bel', 'eng', 'lon', 'yor', 'edi']},
  'nwy': {'type': 'coastal', 'supply': 'neutral', 'borders': ['nrg', 'bar', 'stp', 'fin', 'swe', 'ska', 'nth']},
  ...
  'nap': {'type': 'coastal', 'supply': 'italy', 'borders': ['apu', 'ion', 'tyn', 'rom']},
  'tyn': {'type': 'water', 'borders': ['gol', 'tus', 'rom', 'nap' , 'ion', 'tun', 'wes']},
  'wes': {'type': 'water', 'borders': ['gol', 'tyn', 'tun', 'naf', 'mid', 'spa']},
  'spa': {'type': 'coastal', 'supply': 'neutral', 'borders': ['mid', 'gas', 'mar', 'gol', 'wes', 'por']},
  'por': {'type': 'coastal', 'supply': 'neutral', 'borders': ['mid', 'spa']},
  'gas': {'type': 'coastal', 'supply': 'none', 'borders': ['bre', 'par', 'bur', 'mar', 'spa', 'mid']},
  'bre': {'type': 'coastal', 'supply': 'france', 'borders': ['eng', 'pic', 'par', 'gas', 'mid']},
  ...
  'rom': {'type': 'coastal', 'supply': 'italy', 'borders': ['tus', 'ven', 'apu', 'nap', 'tyn']},
  'gol': {'type': 'water', 'borders': ['mar', 'pie', 'tus', 'tyn', 'wes', 'spa']},
  'mar': {'type': 'coastal', 'supply': 'france', 'borders': ['bur', 'pie', 'gol', 'spa', 'gas']},
  ...
  'tus': {'type': 'coastal', 'supply': 'none', 'borders': ['ven', 'rom', 'tyn', 'gol', 'pie']},
  'pie': {'type': 'coastal', 'supply': 'none', 'borders': ['tyr', 'ven', 'tus', 'gol', 'mar']},
